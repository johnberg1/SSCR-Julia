import Knet
using Knet: conv4, pool, mat, KnetArray, zeroone, param, param0, dropout, relu, batchnorm, bnmoments, bnparams, RNN
...
Encoder = Chain(RNN(300,512,rnnType=:gru,numLayers=1,bidirectional=true))
